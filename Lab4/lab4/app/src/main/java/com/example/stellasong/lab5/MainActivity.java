...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < Name.length; i++)
            goods.add(new Goods(Name[i], Info[i], Price[i], "0"));

        // 将物品清单装填到RecyclerView中
        mRecyclerView = (RecyclerView)findViewById(R.id.shop);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mAdapter = new ShopAdapter(goods, MainActivity.this);
        ...
        // 将购物车清单装填到ListView中
        cargoods.add(new Goods("*购物车", "", "价格", "0"));
        shopAdapter = new ShopcarAdapter(cargoods, MainActivity.this);
        ...
        mAdapter.setOnItemClickListener(new ShopAdapter.OnItemClickListener() {
            ...
            public void onClick(int position) {
                ...
                String tag = (String)goods.get(position).getTag();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                String tag = (String)goods.get(i).getTag();
                intent.putExtra("Tag", tag);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if(requestCode == 0 && resultCode == 2) {
            ...
            Object tag = intent.getStringExtra("Tag");
            cargoods.add(new Goods(nam, info, pri, tag));
            shopAdapter.notifyDataSetChanged();
        }
    }
}
